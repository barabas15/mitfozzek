    ...
    <div className="app">
      <div className="header">
        ...
        {user ? (
          ...
          <button className="btn btn-google" onClick={handleGoogleLogin}>Bejelentkezés Google-lal</button>
        )}
      </div>
      <div className="buttons">
        <button className="btn btn-primary" onClick={handleSuggest}>Mit főzzek?</button>
        <button className="btn btn-secondary" onClick={handleNew}>Új étel</button>
        <button className="btn btn-secondary" onClick={() => setPage('foods')}>Ételeim</button>
      </div>
